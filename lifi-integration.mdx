...
Example input transaction: [`0ecfb9b7...9e1532`](https://mempool.space/tx/0ecfb9b7117b34fb7c1881a3615bbe5208881293956892f5af11b13bb89e1532). The `OP_RETURN` scriptpubkey is `6a06616138643331`—`6a` is `OP_RETURN`, `06` is the push length, and `616138643331` is the ASCII string `aa8d31`: `BigInt("11177265").toString(16)` embedded as six ASCII bytes. This transaction predates the `;` terminator; with today's `call_data = "11177265;"`, the payload would be the ASCII bytes of `aa8d31;`. Both forms are matched.
