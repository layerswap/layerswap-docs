---
title: "Configuration"
description: "Configure the Layerswap Widget with its config object, callbacks, wallet options, and loader-level props."
---
...
<Note>
  `initialValues` is typed as `unknown` in the public package, so your editor won't autocomplete its fields — use the [Initial Values reference](/widget/initial-values) as the source of truth.
</Note>
