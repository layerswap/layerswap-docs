---
title: "Swap Widget Quickstart"
description: "Add the Swap Widget to your React app with @layerswap/widget-react — one package, no CSS imports, no bundler config."
---
