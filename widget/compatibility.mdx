...
- If the widget never mounts, check the top-level `onError` payload against the [manifest failure modes](/widget/how-it-works#manifest-failure-modes).
- If you serve a Content Security Policy, make sure the CDN origin is allowlisted — see the [recommended CSP](/widget/how-it-works#recommended-content-security-policy).
