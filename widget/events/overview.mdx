...
- `callbacks.onError` reports errors inside a running widget. Failures to *load* the widget surface through the top-level `onError` prop instead — see [How It Works & Security](/widget/how-it-works#two-error-channels).
