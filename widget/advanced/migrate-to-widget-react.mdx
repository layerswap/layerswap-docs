...
- **Widget updates roll forward automatically** on the CDN channel—you no longer pin the remote implementation through npm. Verify the final 2.x release-channel policy on release day. See [How the Widget works](/widget/how-it-works).
...
- **If you serve a CSP**, allowlist the widget CDN origin — see the [recommended CSP](/widget/how-it-works#recommended-content-security-policy).
