...
<Warning>
  This page applies to the self-bundled Widget. The loader packages do not accept custom provider factories; contact the team if their built-in provider model does not cover your integration.
</Warning>
...
<Note>
  **Get Your API Keys:**
  ...
  - Layerswap: Generate from the [Partner Dashboard](/get-started/api-keys)
