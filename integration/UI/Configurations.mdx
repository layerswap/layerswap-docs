...
<ResponseField name="defaultTab" type="swap | cex | deposit">
  ...
  - `deposit` — Easy Deposit flow (`easy` is accepted as an alias). See the dedicated [Easy Deposit](/integration/UI/Widget/EasyDeposit) page.
</ResponseField>
...
<ResponseField name="lockFromAsset" type="true or false">
  If set to true, the source asset will be locked for editing.
</ResponseField>

<ResponseField name="lockToAsset" type="true or false">
