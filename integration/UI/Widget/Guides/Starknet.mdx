...
```typescript yarn
yarn add @layerswap/widget zustand @layerswap/wallet-starknet
```


```typescript pnpm
pnpm add @layerswap/widget zustand @layerswap/wallet-starknet
```
...
If you want to override the native widget package, refer to the guide on [Dynamic Labs SDK](/integration/UI/Widget/Guides/StarknetWithDynamics) implementation.
...
<img
  ...
  style={{ width:"450px",height:"auto",margin:"auto",paddingBottom:"20px" }}
