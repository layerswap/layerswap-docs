...
To enable support for more networks like Bitcoin, Solana, TON and others, install the respective packages of each network type and pass it to walletProviders. For more details see the [quickstart](/integration/UI/Widget/Quickstart).
