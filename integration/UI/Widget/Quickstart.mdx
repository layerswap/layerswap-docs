...
export const QuickstartEmbed = () => {
  ...
  const snippetLines = [
    ...
    "      configs={{",
    "        apiKey: 'YOUR_API_KEY',",
    "        version: 'APP_VERSION' //'mainnet' or 'testnet'",
    "      }}",
...
`YOUR_API_KEY` is used for accessing the widget and should be stored privately. You can generate and input it from the [**Dashboard**](https://layerswap.io/dashboard).

//TODO Add link to all configurations