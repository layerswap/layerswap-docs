        ...
        {WALLET_OPTIONS.map((w) => {
          ...
          return (
            <button
              ...
              style={{
                padding: '0.35rem 0.65rem',
                border: isSelected ? '1px solid rgba(99, 102, 241, 0.5)' : '1px solid rgba(255,255,255,0.12)',
...
`YOUR_API_KEY` is used for accessing the widget and should be stored privately. You can generate and input the [**API key**](/api-reference/api-keys) from the Partner Dashboard.
