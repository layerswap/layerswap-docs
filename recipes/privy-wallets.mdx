---
title: 'Bridge ERC-20 Tokens with Privy Server Wallets'
description: 'Bridge ERC-20 tokens through Layerswap from a Privy server wallet using gas sponsorship'
---
