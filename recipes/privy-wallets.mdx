...
This flow creates a Layerswap swap with `use_depository: true`, batches ERC-20 approval when needed, and submits the calls through Privy gas sponsorship. See the [full example on GitHub](https://github.com/layerswap/examples/tree/main/privy-wallets).
