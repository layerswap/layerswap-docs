...
<Warning title="🚧 Needs review — hosted-page key requirements (M3)">
  The long-term policy for unkeyed partner URLs and the exact key or client identifier required for Partner Dashboard branding is not confirmed. Test branding and attribution with your app configuration before launch.
</Warning>
...
<Warning title="🚧 Needs review — iframe CSP (S-15)">
  Layerswap-side `frame-ancestors` and the complete host/iframe CSP requirements have not been confirmed. Verify that the production page permits your origin before committing to iframe delivery.
</Warning>
