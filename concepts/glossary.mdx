...
<Warning title="🚧 Needs review — terminology (Q3.7)">These terms are internally consistent with the current API and Widget contracts, but the product-language choices still need final validation.</Warning>
...
**Layerswap Widget**  
The embeddable UI product. Use `@layerswap/widget-react` in React, `@layerswap/widget-js` in other browser frameworks, or the self-bundled `@layerswap/widget` for advanced requirements.
