...
<Warning title="🚧 Needs review — terminology (D2)">“Funding method” is the proposed umbrella term for wallet transfers, deposit addresses, Depository calls, and gasless deposits. API and Widget field names still use `deposit` where noted.</Warning>
...
<Warning title="🚧 Needs review — awaiting API answers (Q2.8/Q2.9)">The table is limited to structures verified in the API specification. Gasless validity rules and additional Depository operational guarantees remain unconfirmed.</Warning>
