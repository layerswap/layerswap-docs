...
{/* TODO(API, Q2.3): The widget's internal enum knows three more states (`created`, `user_transfer_delayed`, `cancelled`). Confirm whether the API can return them to integrators; this page documents the seven statuses in the API contract today. */}
