...
<Warning title="🚧 Needs review — awaiting API answer (Q2.1)">Quotes carry no expiry field, and the rate guarantee between quoting and depositing is undefined. Until answered, treat quotes as indicative pricing, not locked rates.</Warning>
...
<Warning title="🚧 Needs review — awaiting API answer (Q2.7)">Whether an over-maximum deposit is refunded automatically or requires intervention is unconfirmed.</Warning>
