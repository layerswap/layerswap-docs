...
[How the Widget works](/widget/how-it-works) is the canonical reference for the trust root, validation sequence, Content Security Policy, failure behavior, and release channel.
