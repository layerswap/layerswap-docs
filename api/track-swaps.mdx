...
<Warning title="🚧 Needs review — polling and rate limits (Q2.4)">
...
Status filters are case-sensitive PascalCase values and are **not** the snake_case values returned on swap objects:
