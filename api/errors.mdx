...
<Warning title="🚧 Needs review — refund rules (Q2.7)">
  The conditions for automatic refunds, `refund_address` requirements, over-maximum deposits, and refunds smaller than gas remain unconfirmed. Surface the observable status and transaction data without promising recovery timing.
</Warning>
